...
print('---- Test on G1 by dijkstra without heap ----')
s_id = s_name[0] 
startTime = time.time()
dijkstra.dijkstra_array(g1, s_id)
elaspedTime = time.time() - startTime
...
title = 'Running time of the test on G1 by dijkstra without heap'
fn = 'dij_arr_g1'
a_plot(et_arr, title, fn)


print('---- Test on G2 by dijkstra without heap ----')
s_id = s_name[0] 
startTime = time.time()
dijkstra.dijkstra_array(g2, s_id)
elaspedTime = time.time() - startTime
print('#1 pair elaspedTime: %f' % elaspedTime)
#for v in g1:
#    print("( %s , %s )" % (v.getId(), v.getDist()))
...
for i in range(1,6):
    ...
    et_arr.append(et)
    print('#%d elaspedTime: %f' % (i+1, et))
title = 'Running time of the test on G2 by dijkstra without heap'
fn = 'dij_arr_g2'
a_plot(et_arr, title, fn)

print('---- Test on G1 by dijkstra with heap ----')
s_id = s_name[0]
startTime = time.time()
dijkstra.dijkstra(g1, s_id)
elaspedTime = time.time() - startTime
print('#1 pair elaspedTime: %f' % elaspedTime)
#for v in g1:
#    print("( %s , %s )" % (v.getId(), v.getDist()))
...
for i in range(1,6):
    ...
    et = time.time() - startTime
    et_arr.append(et)
    print('#%d elaspedTime: %f' % (i+2, et))
title = 'Running time of the test on G1 by dijkstra with heap'
fn = 'dij_g1'
a_plot(et_arr, title, fn)

print('---- Test on G2 by dijkstra with heap----')
s_id = s_name[0]
startTime = time.time()
dijkstra.dijkstra(g2, s_id)
elaspedTime = time.time() - startTime
print('#1 pair elaspedTime: %f' % elaspedTime)
et_arr = [elaspedTime]
for i in range(1,6):
    ...
    et_arr.append(et)
    print('#%d elaspedTime: %f' % (i+1, et))
title = 'Running time of the test on G2 by dijkstra with heap'
fn = 'dij_g2'
a_plot(et_arr, title, fn)
